...
import img from '../../../../assets/flavorsome.png';
                        ...
                        <div className="py-10 sm:py-16 lg:py-24 2xl:pl-24">
                            <div className="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 lg:gap-x-8 2xl:gap-x-20">
                                <div className="lg:order-2 2xl:-mr-24">
                                    <img className="w-full shadow-xl rounded-xl" src={img} alt="toy|troppers" />
                                </div>

                                <div className="lg:order-1">
                                    <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl lg:leading-snug">
                                        Flavorsome | Food <br className="hidden xl:block" />
                                        Schools
                                    </h2>
                                    ...
                                    <ul className="grid grid-cols-1 mt-4 sm:mt-10 sm:grid-cols-2 gap-x-10 xl:gap-x-16 gap-y-4 xl:gap-y-6">
                                        <li className="flex items-center">
                                            ...
                                            <span className="ml-3 font-medium text-white"> Summer Food Schools where student Learn Different Food Making </span>
                                        </li>
                                        ...
                                        <li className="flex items-center">
                                            ...
                                            <span className="ml-3 font-medium text-white"> Different Types Culinary Arts Learn </span>
                                        </li>
                                        ...
                                        <li className="flex items-center">
                                            ...
                                            <span className="ml-3 font-medium text-white"> Child and Parents Familiars </span>
                                        </li>
                                        ...
                                        <li className="flex items-center">
                                            ...
                                            <span className="ml-3 font-medium text-white"> Dark and Light Mode Enabled </span>
                                        </li>
                                        <li className="flex items-center">
                                            <svg className="flex-shrink-0 w-5 h-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                                <path
                                            ...
                                            <span className="ml-3 font-medium text-white"> Admin,Instructor and Student Dashboard </span>
                                        </li>
                                    ...
                                    <div className="flex  items-center md:items-start justify-center md:justify-start gap-6 md:gap-0 mt-8 sm:space-x-4 sm:flex-row sm:items-center lg:mt-12">
                                        <a
                                            href="https://flavorsome-food-school.web.app/"
                                            title="Toy|Troppers"
                                            target="_blank"
