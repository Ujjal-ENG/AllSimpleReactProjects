...
import img from '../../../../assets/coffeExpress.png';

const ConffeExpresso = () => {
    return (
                        ...
                        <div className="grid items-center grid-cols-1 gap-y-8 lg:grid-cols-2 lg:gap-x-8 2xl:gap-x-20">
                            ...
                            <motion.div
                                ...
                                <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl lg:leading-snug">
                                    Coffee | a Sweet Love <br className="hidden xl:block" />
                                    Expresso Story
                                </h2>
                                ...
                                <ul className="grid grid-cols-1 mt-4 sm:mt-10 sm:grid-cols-2 gap-x-10 xl:gap-x-16 gap-y-4 xl:gap-y-6">
                                    <li className="flex items-center">
                                        ...
                                        <span className="ml-3 font-medium text-white"> Drink Coffee Feel Coffee </span>
                                    </li>
                                    ...
                                    <li className="flex items-center">
                                        ...
                                        <span className="ml-3 font-medium text-white"> USA top Rated Coffees </span>
                                    </li>
                                ...
                                <div className="flex  items-center md:items-start justify-center md:justify-start gap-6 md:gap-0 mt-8 sm:space-x-4 sm:flex-row sm:items-center lg:mt-12">
                                    <a
                                        href="https://645a87d8c48da61294b0cdcd--beamish-biscotti-f407f6.netlify.app/"
                                    ...
                                    <a
                                        href="https://github.com/Ujjal-ENG/AllSimpleReactProjects/tree/main/coffee-expresso"
                                        target="_blank"
