        ...
        children: [
            {
                ...
                loader: async () => fetch('https://server-ujjal-eng.vercel.app/all-news')
            },
            {
                path: ':id',
                element: <LeftNavCategoriresData />,
                loader: async ({ params }) => fetch(`https://server-ujjal-eng.vercel.app/category/${params.id}`)
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                loader: async ({ params }) => fetch(`https://server-ujjal-eng.vercel.app/news/${params.id}`)
            }
        ]
    }
]);
