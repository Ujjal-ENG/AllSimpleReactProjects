...
const Footer = () => {
    return (
        <div>
            <section className="py-10 bg-gray-400 text-white sm:pt-16 lg:pt-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    <p className="text-sm text-center text-gray-600">© Copyright 2023, All Rights Reserved by Ujjal Kumar Roy</p>
                </div>
            </section>
        </div>
    );
