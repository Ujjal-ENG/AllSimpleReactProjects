        ...
        <div className="border-b-2 border-black pb-8">
            ...
            <div className="grid grid-cols-3 justify-items-center">
                <div className="col-span-1">
                    <img src={img} alt="group" className="pl-20" />
                </div>
                <div className="col-span-2 w-full">
                    ...
                    <div className="grid grid-cols-4 justify-items-center pt-10 bg-gradient-to-t from-transparent via-[#BADCDC] to-transparent">
